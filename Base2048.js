(function($)
{
    ...
    $.fn.game2048 = function()
    {
        function generate_map()
        {
            ...
            for (var y = 0; y < size; y++){
                ...
                for (var x = 0; x < size; x++) {
                    var cases = $('<td id="cell">0</td>').attr('x', x).attr('y', y).attr('nbr', 0).attr('merge', 0);
                    ligne.append(cases);
                }
                table.append(ligne);
            }
            borda.append(table);//pas besoin d'injecter le tableau dans chaque tour de boucle
            return borda;
        }
        ...
        function reset_merge(){
            ...
            // ???????? l'objectif est de mettre toutes les cases a merge=0
            // pourquoi une boucle dans une boucle !?
            /*
        ...
        */
        ...
        // ?????
        // Pourquoi ne pas dire "c'est gagné" directement quand tu fais le "mergeValue" ?
        // ou mettre en mémoire qu'il y a un 2048
        // Ici tu parcours le dom pour savoir si c'est gagné, niveau perf c'est moyen :/
        function setWin(){

            var win; // ??? A quoi sert la variable ?
